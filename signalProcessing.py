...
# 按照指定的时间窗口和滑动长度，从起始时间开始切割数据段，并对每个数据段进行平均化处理。返回处理后的数据列表
...
if __name__ == "__main__":
    # for test 2
    data_src = r"../tempdata/gdf"
    labels_src = r"../tempdata/labels"
    data = run_sig_processing(data_src, labels_src, band_type=1)
    # pickle.dump(data,open('save.csv','wb'))
